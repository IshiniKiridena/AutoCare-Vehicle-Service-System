...
<div class="container">
  <h2></h2>
  <div class="alert alert-success alert-dismissible" id="myAlert" data-dismiss="alert">
    <button type="button" class="close">&times;</button>
    <h3><strong>Success!</strong></h3><br> You Have Successfully Done Your Task!!<br>
...
<div class = "container2">
	<img style = "
	  ...
	  width: 50%;
	"alt="" src="images/right4.gif" >
</div>

<div style = "display : flex;" class = "container3">

<a href="MainPage.jsp"><button style = "text-decoration: none; color: white; border-radius: 5px; background-color:#2171ff; margin-left: 400px; margin-top: 50px; width :300px; 
  height : 40px;"
						class="editBtn">
