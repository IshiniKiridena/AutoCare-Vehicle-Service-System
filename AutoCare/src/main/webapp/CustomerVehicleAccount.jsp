...
<body>
	...
	<h2 style="color : black; text-align: center;" id="insertbill" class="animate__animated animate__backInDown">My Vehicles</h2>
    <p style="color: lightcoral; text-align: center;"  class="animate__animated animate__zoomIn">Search vehicles using the vehicle No</p>
	
	<center>
	
	<div><br></div>
	<p>	<input style="width: 600px;" id="searchbar" onkeyup="searchFunction()" type="text" name="search" placeholder="Vehicle no"></p>
	<div><br></div>
	...
	<table border="1" id="myt">
		<tr>
			...
			<th>Transmission</th>
			<th>Technology</th>
			<th>Update Mileage</th>
			<th>Delete Vehicle</th>
			<th>Service this vehicle</th>
		</tr>
		<%
		try {
		...
		<tr>
			...
			<td><%=resultSet.getString("manufacture_year")%></td>
			...
			<td><a
				href="CustomerVehicleUpdate.jsp?vehicleNo=<%= resultSet.getString("vehicle_no")%>"><button
						class="editBtn btn btn-primary">
						<b> Update </b>
					</button></a></td>
			<td><a
				href="CustomerVehicleDelete.jsp?vehicleNo=<%= resultSet.getString("vehicle_no")%>"><button
