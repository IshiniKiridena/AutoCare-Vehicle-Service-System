...
<div class="containerform">
	...
	<table class="table table-striped bordernone" border="1" id="myt">
		...
		<tr>
			<td></td>
			<td>
				<a class="btn btn-outline-primary" href="StockUpdateAll.jsp?partNo=<%=resultSet.getString("partNo")%>&brand=<%=resultSet.getString("brand_name")%>&model=<%=resultSet.getString("model_name")%>&model=<%=resultSet.getString("model_name")%>">UpdateAll</a>
	 	 	</td>
	 	 </tr>
    ...
    <form action="UpdateQuantityServlet" method="post" class="row needs-validation" novalidate>
        
         <div class="col-md-6">
           <label for="validationCustom01" class="form-label">Add new Quantity*</label>
           <input type="number" class="form-control form-control" id="newquantity" name="newquantity" required="">
         ...
         <div class="col-md-6">
           ...
           <input type="date" class="form-control form-control" id="newdate" name="newdate" required="">
             <div class="invalid-feedback">
		...
		<input type= "hidden" name = "prevquantity" value="<%=qty%>">
