...
<body>
        ...
        <div>
            <div name="credential_error" id ="mydiv" class="credential_error"> ${credential_error}</div>
        </div>
    </div>
			...
			try {
				...
				String sql = "select * from viewbookings where userID='"+3+"'";
			...
			%>
			  <tbody>
				<tr>
					...
					<td class="table-primary"><%=resultSet.getString("bookID")%></td>
					<td class="table-primary"><%=resultSet.getString("fname")%></td>
					<td class="table-primary"><%=resultSet.getString("lname")%></td>
					<td class="table-primary"><%=resultSet.getString("vehicle_no")%></td>
					<td class="table-primary"><%=resultSet.getString("service_type")%></td>
					<td class="table-primary"><%=resultSet.getString("amount")%></td>
					<td class="table-primary"><%=resultSet.getString("date")%></td>
					<td class="table-primary"><%=resultSet.getString("time")%></td>	
					<td class="table-danger">
						
						<!-- Button trigger modal -->
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal-<%=resultSet.getString("bookID")%>">
                          Delete
                    </button>
                               
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal-<%=resultSet.getString("bookID")%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Do you really want to delete <%=resultSet.getString("bookID")%> booking?
                            This process cannot be undone.
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                            <a href="bookingDelete.jsp?bookID=<%=resultSet.getString("bookID")%>"><button type="button" class="btn btn-danger">Yes,delete it!</button></a>
                          </div>
                        </div>
                      </div>
                    </div>	
