...
<body>
	...
	<h2 style="color : black; text-align: center;" id="insertbill" class="animate__animated animate__backInDown">Forgot password</h2>
    <p style="color: lightcoral; text-align: center;"  class="animate__animated animate__zoomIn">Please enter your email to recover the account</p>
	
	<!-- Alert -->
	
	<div class="alert alert-success" role="alert">
	  <h4 class="alert-heading">Don't Worry!</h4>
	  <p>Type your email below, and we'll email you a link to reset your password.</p>
	  
	  <br>
	  <form action="#" method = "post" class="row needs-validation" novalidate>
	  <div class="col-md-6" style="width: 500px;">
            <label for="validationCustom01" class="form-label">Email *</label>
            <input type="email" name="forgetEmail" class="form-control" id="validationCustom01" required="">
