...
<title>Access My Bookings</title>
<style type="text/css">
body{
...
<body>
	       ...
	       <!-- Navigation -->
			...
			<c:set var="userFName" value="<%= userFName%>"/>
			<c:set var="userLName" value="<%= userLName%>"/>
	
	<div class="containerform" style="width:800px;"> <!--containerform-->
	
	<h2 style="color : black; text-align: center;" id="insertbill" class="animate__animated animate__backInDown">Access all your bookings here......</h2>
	...
	<div class="row">
	  <div class="col-sm-6">
		<div class="card">
		  <img class="card-img-top" src="images/viewBookings.png" alt="Card image cap">
		  <div class="card-body">
		    <h5 class="card-title">View My Current Bookings</h5>
		    <p class="card-text">Access all your bookings here...</p>
                <c:url value="" var="cusCurBook">
				<c:param name="userID" value="${userID}"></c:param>
				<c:param name="userFName" value="${userFName}"></c:param>
				<c:param name="userLName" value="${userLName}"></c:param>
				</c:url>
				<a href="${cusCurBook}">
				<input type="button" name="book" class="btn btn-primary" value="My Current Bookings">
				</a>
		  </div>
		</div>
	    </div>
	  ...
	  <div class="col-sm-6">
	    <div class="card">
		  ...
		  <div class="card-body">
		    <h5 class="card-title">Get My Booking report</h5>
		    <p class="card-text">Get a report of your current bookings here...</p>
		    	<c:url value="CustomerBookingsReport.jsp" var="cusCurRepBook">
				<c:param name="userID" value="${userID}"></c:param>
				<c:param name="userFName" value="${userFName}"></c:param>
				<c:param name="userLName" value="${userLName}"></c:param>
				</c:url>
				<a href="${cusCurRepBook}">
				<input type="button" name="book" class="btn btn-primary" value="Get Booking Report">
				</a>
		  </div>
		</div>
	  </div>
