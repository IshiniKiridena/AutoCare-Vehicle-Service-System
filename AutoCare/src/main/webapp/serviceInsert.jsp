...
<div>
	...
	<form class="row needs-validation" novalidate action="ServiceInsert" method="post">
		<div class="col-md-6">
			<label for="validationCustom01" class="form-label">Service Type : </label>
			<input type="text" name="servicename" class="form-control" id="validationCustom01" required="">
		...
		<div class="col-md-6">
			...
			<textarea rows="4" cols="50" name="description" class="form-control" id="validationCustom01" required=""></textarea>
				<div class="invalid-feedback">
