...
<title>Vehicle Details Delete</title>
<style type="text/css">
body{
...
<body>
	...
	<h2 style="color : black; text-align: center;" id="insertbill" class="animate__animated animate__backInDown">Delete My Vehicle</h2>
    <p style="color: lightcoral; text-align: center;"  class="animate__animated animate__zoomIn">You can delete vehicle details here</p>
	
	<form action="VehicleDeleteServlet" method="post" class="row needs-validation" novalidate>
        ...
        <div class="col-md-6" style="width: 350px;">
            ...
            <input type="text" name="vehicleMileage" class="form-control" id="validationCustom01" value="<%=resultSet.getString("mileage")%>" readonly="readonly">
        </div>
        ...
        <div class="alert alert-danger" role="alert">
		  <h4 class="alert-heading">Before you delete your vehicle!</h4>
		  <p>Please note that if you proceed to delete the vehicle details, you will not be able to book services for the particular vehicle</p>
		
		  <button style="width: 150px; height : 35px; padding-bottom: 10px; margin-top: 30px; margin-left: 1px; background-color: #2171ff; border-color: #2171ff; font-size: 16px;" type="button" class="btn btn-primary btn-sm" onclick="goBack()">Keep My Vehicle</button>         
          <button style="width: 400px; height : 35px; padding-bottom: 10px; margin-top: 30px; margin-left: 15px; background-color: red; border-color: red; font-size: 17px;"  type="submit" class="btn btn-secondary btn-sm">Delete Vehicle Details</button>
