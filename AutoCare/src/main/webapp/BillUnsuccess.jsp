...
<div class="container">
  <h2></h2>
   <div class="alert alert-warning">
    <p style = "color : white;"><strong style = "color : black">Warning!</strong> <br>Sorry! You could not update data correctly.</p>
  </div>
...
<div class = "container2">
	<img style = "
	  ...
	  margin-right: auto;
	  width: 40%;
	"alt="" src="images/warning.png" >
</div>


  <a href="SearchBill.jsp"><button style = "text-decoration: none; color: white; border-radius: 5px; background-color:#2171ff; margin-left: 400px; margin-top: 50px; width :300px; 
  height : 40px;"
						class="editBtn">
