...
<body>
	...
	<h2 style="color : black; text-align: center;" id="insertbill" class="animate__animated animate__backInDown">Employee Login</h2>
	...
	<form action="EmployeeLoginServlet" method = "post" class="row needs-validation" novalidate>
		
		<div class="col-md-6" style="width: 500px;">
            <label for="validationCustom01" class="form-label">Email *</label>
            <input type="email" name="empEmail" class="form-control" id="validationCustom01" required="">
        ...
        <div class="col-md-6" style="width: 500px;">
            ...
            <input type="password" name="empPW" class="form-control" id="validationCustom01" required="">
              <div class="invalid-feedback">
